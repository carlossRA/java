...
<link href="src/main/webapp/WEB-INF/css/bootstrap.min.css" rel="stylesheet" media="screen">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="home.htm">Abrir/Cerrar fichajes<span class="sr-only">(current)</span></a>
          <a class="dropdown-item" href="consulta.htm">Consultar fichajes</a>
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="vistaCambiarContrasena.htm">Cambiar contraseña</a>
          <div class="dropdown-divider"></div>
